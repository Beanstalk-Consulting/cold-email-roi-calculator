          ...
          {includeLinkedIn && (
            <div className="space-y-6 py-4 pl-10">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="w-[250px]">First profile: $1,499/mo, Additional profiles: $149/mo each</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <div className="flex items-center gap-2">
              ...
              <RangeInput
                ...
                max={50}
                step={1}
                tooltip="Percentage of accepted connections that reply to messages"
              />
              ...
              <RangeInput
                ...
                max={20}
                step={1}
                tooltip="Percentage of accepted connections that express interest and become leads"
              />
